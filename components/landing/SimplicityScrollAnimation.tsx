...
export default function SimplicityScrollAnimation() {
    ...
    useEffect(() => {
        ...
        const loadImages = async () => {
            for (let i = 0; i < FRAME_COUNT; i++) {
                ...
                img.src = `/simplicity-sequence/frame_${formattedIndex}.jpg`;
                ...
                <div className="w-full md:w-[35%] flex flex-col justify-center z-10 p-4 order-2 md:order-1">
                    ...
                    >
                        ...
                        <p className="text-lg text-slate-600 leading-relaxed">
                            Why complicate things? A clean, calm interface helps you focus on your data without the noise.
                            ReNotify is built to be powerful yet incredibly simple to use.
                        </p>
                    </motion.div>
                </div>
